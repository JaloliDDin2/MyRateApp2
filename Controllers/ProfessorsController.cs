...
namespace MyRateApp2.Controllers
{
    public class ProfessorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProfId,Fname,Name,Department,UniName,UniId")] Professor professor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProfId,Fname,Name,Department,UniName,UniId")] Professor professor)
        {

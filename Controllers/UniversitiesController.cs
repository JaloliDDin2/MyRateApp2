...
namespace MyRateApp2.Controllers
{
    public class UniversitiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UniId,UniName,UniCountry,UniState,UniWebsite,UniEmail")] University university)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UniId,UniName,UniCountry,UniState,UniWebsite,UniEmail")] University university)
        {
